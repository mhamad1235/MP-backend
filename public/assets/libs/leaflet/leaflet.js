...
!(function (t, e) {
  ...
  function be(t, e, i) {
    e = e || new p(0, 0);
    t.style[ue] =
      (b.ie3d ? 'translate(' + e.x + 'px,' + e.y + 'px)' : 'translate3d(' + e.x + 'px,' + e.y + 'px,0)') + (i ? ' scale(' + i + ')' : '');
  }
  function Z(t, e) {
  ...
  function De(t, e) {
    var i, n;
    return e
      ? ((n = (i = Ze(e)).boundingClientRect), new p((t.clientX - n.left) / i.x - e.clientLeft, (t.clientY - n.top) / i.y - e.clientTop))
        ...
        return (
          ...
          (t = m(t).round()).x || t.y
            ? (!0 === e.animate || this.getSize().contains(t)
                ? (this._panAnim ||
                    ((this._panAnim = new Fe()), this._panAnim.on({step: this._onPanTransitionStep, end: this._onPanTransitionEnd}, this)),
      ...
      getSize: function () {
        return (
          (this._size && !this._sizeChanged) ||
            ((this._size = new p(this._container.clientWidth || 0, this._container.clientHeight || 0)), (this._sizeChanged = !1)),
          this._size.clone()
        );
      },
      ...
      _fireDOMEvent: function (t, e, i) {
        ...
        if (n.length) {
          ...
          for (
            ...
            if (
              (n[s].fire(e, h, !0), h.originalEvent._stopped || (!1 === n[s].options.bubblingMouseEvents && -1 !== G(this._mouseEvents, e)))
            )
              return;
        }
      },
  ...
  var B = et.extend({
      ...
      remove: function () {
        return (
          this._map &&
            (T(this._container), this.onRemove && this.onRemove(this._map), this._map.off('unload', this.remove, this), (this._map = null)),
          this
        );
      },
      ...
      B.extend({
        ...
        _initLayout: function () {
          var t = 'leaflet-control-layers',
            ...
            o =
              (i && (this._map.on('click', this.collapse, this), S(e, {mouseenter: this._expandSafely, mouseleave: this.collapse}, this)),
    ...
    Ke = B.extend({
      options: {
        ...
        prefix:
          '<a href="https://leafletjs.com" title="A JavaScript library for interactive maps">' + (b.inlineSvg ? `` : '') + 'Leaflet</a>',
      },
      initialize: function (t) {
    ...
    Xe = it.extend({
      ...
      _onMove: function (t) {
        ...
        this._enabled &&
          (t.touches && 1 < t.touches.length
            ? (this._moved = !0)
            : (!(e = new p((e = t.touches && 1 === t.touches.length ? t.touches[0] : t).clientX, e.clientY)._subtract(this._startPoint))
                .x &&
                !e.y) ||
  ...
  function $e(t, e) {
    ...
    for (
      var l = w([0, 0]),
        u = g(t),
        c = (u.getNorthWest().distanceTo(u.getSouthWest()) * u.getNorthEast().distanceTo(u.getNorthWest()) < 1700 && (l = Qe(t)), t.length),
        d = [],
        _ = 0;
      _ < c;
      _++
  ...
  function hi(t, e) {
    ...
    for (
      var h = w([0, 0]),
        l = g(t),
        u = (l.getNorthWest().distanceTo(l.getSouthWest()) * l.getNorthEast().distanceTo(l.getNorthWest()) < 1700 && (h = Qe(t)), t.length),
        c = [],
        d = 0;
      d < u;
      d++
    ...
    mi = o.extend({
      ...
      _initIcon: function () {
        var t = this.options,
          ...
          i =
            (i !== this._icon &&
              (this._icon && this._removeIcon(), (n = !0), t.title && (i.title = t.title), 'IMG' === i.tagName && (i.alt = t.alt || '')),
            M(i, e),
    ...
    _containsPoint: function (t, e) {
      ...
      if (this._pxBounds && this._pxBounds.contains(t))
        for (i = 0, s = this._parts.length; i < s; i++)
          for (n = 0, o = (r = (a = this._parts[i]).length) - 1; n < r; o = n++) if ((e || 0 !== n) && ii(t, a[o], a[n]) <= h) return !0;
      return !1;
    },
  });
  yi._flat = ai;
      ...
      Ai.extend({
        ...
        onAdd: function (t) {
          Ai.prototype.onAdd.call(this, t),
            ...
            this._source &&
              (this._source.fire('popupopen', {popup: this}, !0), this._source instanceof fi || this._source.on('preclick', Ae));
        },
        onRemove: function (t) {
          Ai.prototype.onRemove.call(this, t),
            t.fire('popupclose', {popup: this}),
            this._source &&
              (this._source.fire('popupclose', {popup: this}, !0), this._source instanceof fi || this._source.off('preclick', Ae));
        },
        getEvents: function () {
    ...
    _abortLoading: function () {
      ...
      for (t in this._tiles)
        this._tiles[t].coords.z !== this._tileZoom &&
          ...
          (i.onerror = u),
          i.complete ||
            ((i.src = K), (e = this._tiles[t].coords), T(i), delete this._tiles[t], this.fire('tileabort', {tile: i, coords: e})));
    },
    _removeTile: function (t) {
      var e = this._tiles[t];
    ...
    zt = {
      ...
      _updateStyle: function (t) {
        ...
        (o.stroked = !!n.stroke),
          ...
          n.fill
            ? ((i = i || (t._fill = Vi('fill'))), o.appendChild(i), (i.color = n.fillColor || n.color), (i.opacity = n.fillOpacity))
  ...
  var _t = n.extend({
      ...
      _finish: function () {
        this._moved && (T(this._box), z(this._container, 'leaflet-crosshair')),
          ae(),
          Te(),
          k(document, {contextmenu: Re, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown}, this);
      },
